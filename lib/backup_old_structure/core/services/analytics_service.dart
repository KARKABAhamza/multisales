...
class AnalyticsService {
  ...
  AnalyticsService._internal(); // Private constructor
  ...
  Future<void> logLogin({String? method}) async {
    try {
      await _analytics.logLogin(loginMethod: method ?? 'email'); // Log user login
      if (kDebugMode) {
  ...
  Future<void> logSignUp({String? method}) async {
    try {
      await _analytics.logSignUp(signUpMethod: method ?? 'email'); // Log user signup
      if (kDebugMode) {
  ...
  Future<void> logOnboardingStart({String? userRole}) async {
    try {
      await _analytics.logEvent( // Log onboarding start event
