...
class LanguageProvider with ChangeNotifier {
  ...
  Future<void> changeLanguage(Locale locale) async {
    if (!supportedLocales.contains(locale)) {
      _setError('Language not supported: ${locale.languageCode}'); // Error handling
      return;
    }
  ...
  Future<void> changeLanguageByCode(String languageCode) async {
    ...
    // Change language based on provided language code
  ...
  Future<void> _loadSavedLanguage() async {
    try {
      ...
      _setError('Failed to load language preference: ${e.toString()}'); // Error handling
    }
  }
