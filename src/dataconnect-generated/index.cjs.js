...
const getReviewsForProductRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetReviewsForProduct', inputVars);
}
getReviewsForProductRef.operationName = 'GetReviewsForProduct';
exports.getReviewsForProductRef = getReviewsForProductRef;

exports.getReviewsForProduct = function getReviewsForProduct(dcOrVars, vars) {
  return executeQuery(getReviewsForProductRef(dcOrVars, vars));
};
